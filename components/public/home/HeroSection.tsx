...
export async function HeroSection() {
  ...
  console.log({ locale, test: t('pages.home.hero.badge') })
  return (
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-zinc-900 dark:text-white mb-6 text-balance leading-tight">
            {t('pages.home.hero.mainTitle.first')} <span className="text-amber-600 dark:text-amber-400">   {t('pages.home.hero.mainTitle.seconde')}</span>    {t('pages.home.hero.mainTitle.thirth')}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <span>{t('pages.home.hero.exploreStadiums')}
              </span> <HiArrowRight className="rtl:rotate-180" />
            </Link>
            <Link
            ...
            >
              <span>{t('pages.home.hero.howItWorks')}</span> <HiPlay className="rtl:rotate-180" />
            </Link>
          </div>
        </div>
