    ...
    <section className="py-20 md:py-32">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            {t('pages.home.ctaSection.title')} <span className="text-amber-600 dark:text-amber-400"> {t('pages.home.ctaSection.highlightedWord')}</span> 
          </h2>
          ...
          >
{t('pages.home.ctaSection.description')}          </p>
          ...
          >
            ...
            >
              {t('pages.home.ctaSection.buttons.createAccount')} <HiArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform rtl:rotate-180" />
            </Link>
            <Link
              className={cn("ffont-semibold px-8 border-zinc-300 dark:border-zinc-700", button({ size: "lg", variant: "bordered", color: "warning" }))}
              href="/contact"
            >
              {t('pages.home.ctaSection.buttons.contactUs')} <HiPhone className="w-5 h-5 " />
            </Link>
          </div>
