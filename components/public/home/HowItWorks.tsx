          ...
          {steps.map((step, index) => (
            ...
            >
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 ltr:left-[calc(50%+3rem)] rtl:right-[calc(50%+3rem)] w-[calc(100%-4rem)] h-0.5 bg-zinc-200 dark:bg-zinc-800">
                  <motion.div
                    ...
                    className="h-full bg-amber-500 ltr:origin-left rtl:origin-right"
                  />
                </div>
              )}
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-2">{t(`pages.home.howItWorks.steps.${step.label}.title`)}
                </h3>
                <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">{t(`pages.home.howItWorks.steps.${step.label}.description`)}
                </p>
              </div>
            </motion.div>
          ))}
